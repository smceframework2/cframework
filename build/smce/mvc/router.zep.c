...
PHP_METHOD(Smce_Mvc_Router, __construct) {
	...
	if (defaultRoutes) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_3, 91, _2, _1);
		...
		ZEPHIR_CALL_METHOD(NULL, _2, "__construct", &_3, 91, _5, _4);
...
PHP_METHOD(Smce_Mvc_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, route, "__construct", NULL, 91, pattern, paths, httpMethods);
	zephir_check_call_status();
