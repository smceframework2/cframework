...
PHP_METHOD(Smce_Mvc_Router, __construct) {
	...
	if (defaultRoutes) {
		...
		object_init_ex(_0$$3, smce_mvc_router_route_ce);
		ZEPHIR_INIT_VAR(_1$$3);
		zephir_create_array(_1$$3, 1, 0 TSRMLS_CC);
		add_assoc_long_ex(_1$$3, SS("controller"), 1);
		ZEPHIR_INIT_VAR(_2$$3);
		ZVAL_STRING(_2$$3, "#^/([a-zA-Z0-9\\_\\-]+)[/]{0,1}$#", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _0$$3, "__construct", &_3, 106, _2$$3, _1$$3);
		zephir_check_temp_parameter(_2$$3);
		zephir_check_call_status();
		zephir_array_append(&routes, _0$$3, PH_SEPARATE, "smce/mvc/router.zep", 65);
		ZEPHIR_INIT_NVAR(_2$$3);
		object_init_ex(_2$$3, smce_mvc_router_route_ce);
		...
		ZVAL_STRING(_5$$3, "#^/([a-zA-Z0-9\\_\\-]+)/([a-zA-Z0-9\\.\\_]+)(/.*)*$#", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _2$$3, "__construct", &_3, 106, _5$$3, _4$$3);
		zephir_check_temp_parameter(_5$$3);
		zephir_check_call_status();
		zephir_array_append(&routes, _2$$3, PH_SEPARATE, "smce/mvc/router.zep", 71);
	}
	ZEPHIR_INIT_VAR(_6);
	array_init(_6);
...
PHP_METHOD(Smce_Mvc_Router, getRewriteUri) {
	...
	if (!(zephir_is_true(_0))) {
		ZEPHIR_OBS_VAR(url);
		if (zephir_array_isset_string_fetch(&url, _GET, SS("route"), 0 TSRMLS_CC)) {
...
PHP_METHOD(Smce_Mvc_Router, removeExtraSlashes) {
	...
	if (remove) {
		zephir_update_property_this(this_ptr, SL("_removeExtraSlashes"), ZEPHIR_GLOBAL(global_true) TSRMLS_CC);
	} else {
		zephir_update_property_this(this_ptr, SL("_removeExtraSlashes"), ZEPHIR_GLOBAL(global_false) TSRMLS_CC);
	}
	RETURN_THISW();
...
PHP_METHOD(Smce_Mvc_Router, handle) {
	...
	zval *_14$$27 = NULL, *_19$$34 = NULL, *_21$$37 = NULL;
	HashTable *_4, *_16$$30;
	HashPosition _3, _15$$30;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *uri_param = NULL, *realUri = NULL, *request = NULL, *currentHostName = NULL, *routeFound = NULL, *parts = NULL, *params = NULL, *matches = NULL, *notFoundPaths = NULL, *vnamespace = NULL, *module = NULL, *controller = NULL, *action = NULL, *paramsStr = NULL, *strParams = NULL, *route = NULL, *methods = NULL, *dependencyInjector = NULL, *hostname = NULL, *regexHostName = NULL, *matched = NULL, *pattern = NULL, *handledUri = NULL, *beforeMatch = NULL, *paths = NULL, *converters = NULL, *part = NULL, *position = NULL, *matchPosition = NULL, *converter = NULL, *_0, *_2, **_5, _1$$6, *_6$$11, *_7$$11 = NULL, *_8$$11 = NULL, *_9$$10 = NULL, *_10$$15, *_11$$15 = NULL, *_12$$15 = NULL, *_13$$19 = NULL, **_17$$30, *_18$$34 = NULL, *_20$$37 = NULL, *_22$$45, *_23$$48, *_24$$51, *_25$$54, _26$$55, *_27$$57, *_28$$59, *_29$$59, *_30$$59, *_31$$59, *_32$$59;
	zval *uri = NULL;
	...
	if (zephir_is_true(_0)) {
		if (!ZEPHIR_IS_STRING(realUri, "/")) {
			...
			zephir_fast_trim(handledUri, realUri, &_1$$6, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
		} else {
	...
	zephir_is_iterable(_2, &_4, &_3, 0, 1, "smce/mvc/router.zep", 460);
	for (
	  ...
	  ; zephir_hash_move_backwards_ex(_4, &_3)
		...
		if (Z_TYPE_P(methods) != IS_NULL) {
			if (Z_TYPE_P(request) == IS_NULL) {
				...
				if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(smce_mvc_router_exception_ce, "A dependency injection container is required to access the 'request' service", "smce/mvc/router.zep", 298);
					return;
				}
				ZEPHIR_INIT_NVAR(_8$$11);
				ZVAL_STRING(_8$$11, "request", ZEPHIR_TEMP_PARAM_COPY);
				ZEPHIR_CALL_METHOD(&_7$$11, dependencyInjector, "getshared", NULL, 0, _8$$11);
				zephir_check_temp_parameter(_8$$11);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(request, _7$$11);
			}
			ZEPHIR_CALL_METHOD(&_9$$10, request, "ismethod", NULL, 0, methods);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(hostname) != IS_NULL) {
			if (Z_TYPE_P(request) == IS_NULL) {
				_10$$15 = zephir_fetch_nproperty_this(this_ptr, SL("_dependencyInjector"), PH_NOISY_CC);
				ZEPHIR_CPY_WRT(dependencyInjector, _10$$15);
				if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(smce_mvc_router_exception_ce, "A dependency injection container is required to access the 'request' service", "smce/mvc/router.zep", 325);
					return;
				}
				ZEPHIR_INIT_NVAR(_12$$15);
				ZVAL_STRING(_12$$15, "request", ZEPHIR_TEMP_PARAM_COPY);
				ZEPHIR_CALL_METHOD(&_11$$15, dependencyInjector, "getshared", NULL, 0, _12$$15);
				zephir_check_temp_parameter(_12$$15);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(request, _11$$15);
			}
			...
			if (zephir_memnstr_str(hostname, SL("("), "smce/mvc/router.zep", 348)) {
				if (!(zephir_memnstr_str(hostname, SL("#"), "smce/mvc/router.zep", 349))) {
				...
				zephir_preg_match(matched, regexHostName, currentHostName, _13$$19, 0, 0 , 0  TSRMLS_CC);
			} else {
				ZEPHIR_INIT_NVAR(matched);
		...
		zephir_check_call_status();
		if (zephir_memnstr_str(pattern, SL("^"), "smce/mvc/router.zep", 370)) {
		...
		if (zephir_is_true(routeFound)) {
			...
			if (Z_TYPE_P(beforeMatch) != IS_NULL) {
				...
				zephir_create_array(_14$$27, 3, 0 TSRMLS_CC);
				zephir_array_fast_append(_14$$27, handledUri);
				zephir_array_fast_append(_14$$27, route);
				zephir_array_fast_append(_14$$27, this_ptr);
				ZEPHIR_INIT_NVAR(routeFound);
				ZEPHIR_CALL_USER_FUNC_ARRAY(routeFound, beforeMatch, _14$$27);
				zephir_check_call_status();
			}
		}
		if (zephir_is_true(routeFound)) {
			...
			if (Z_TYPE_P(matches) == IS_ARRAY) {
				...
				zephir_check_call_status();
				zephir_is_iterable(paths, &_16$$30, &_15$$30, 0, 0, "smce/mvc/router.zep", 449);
				for (
				  ; zephir_hash_get_current_data_ex(_16$$30, (void**) &_17$$30, &_15$$30) == SUCCESS
				  ; zephir_hash_move_forward_ex(_16$$30, &_15$$30)
				) {
					ZEPHIR_GET_HMKEY(part, _16$$30, _15$$30);
					ZEPHIR_GET_HVALUE(position, _17$$30);
					...
					if (zephir_array_isset_fetch(&matchPosition, matches, position, 0 TSRMLS_CC)) {
						if (Z_TYPE_P(converters) == IS_ARRAY) {
							...
							if (zephir_array_isset_fetch(&converter, converters, part, 0 TSRMLS_CC)) {
								...
								zephir_create_array(_19$$34, 1, 0 TSRMLS_CC);
								zephir_array_fast_append(_19$$34, matchPosition);
								ZEPHIR_CALL_USER_FUNC_ARRAY(_18$$34, converter, _19$$34);
								zephir_check_call_status();
								zephir_array_update_zval(&parts, part, &_18$$34, PH_COPY | PH_SEPARATE);
								continue;
							}
						}
						...
						if (Z_TYPE_P(converters) == IS_ARRAY) {
							ZEPHIR_OBS_NVAR(converter);
							if (zephir_array_isset_fetch(&converter, converters, part, 0 TSRMLS_CC)) {
								ZEPHIR_INIT_NVAR(_20$$37);
								ZEPHIR_INIT_NVAR(_21$$37);
								zephir_create_array(_21$$37, 1, 0 TSRMLS_CC);
								zephir_array_fast_append(_21$$37, position);
								ZEPHIR_CALL_USER_FUNC_ARRAY(_20$$37, converter, _21$$37);
								zephir_check_call_status();
								zephir_array_update_zval(&parts, part, &_20$$37, PH_COPY | PH_SEPARATE);
							}
						}
					}
				}
	...
	if (zephir_is_true(routeFound)) {
		...
		if (zephir_array_isset_string_fetch(&vnamespace, parts, SS("namespace"), 0 TSRMLS_CC)) {
			...
			_22$$45 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultNamespace"), PH_NOISY_CC);
			zephir_update_property_this(this_ptr, SL("_namespace"), _22$$45 TSRMLS_CC);
		}
		...
		if (zephir_array_isset_string_fetch(&module, parts, SS("module"), 0 TSRMLS_CC)) {
			...
			_23$$48 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultModule"), PH_NOISY_CC);
			zephir_update_property_this(this_ptr, SL("_module"), _23$$48 TSRMLS_CC);
		}
		...
		if (zephir_array_isset_string_fetch(&controller, parts, SS("controller"), 0 TSRMLS_CC)) {
			...
			_24$$51 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultController"), PH_NOISY_CC);
			zephir_update_property_this(this_ptr, SL("_controller"), _24$$51 TSRMLS_CC);
		}
		...
		if (zephir_array_isset_string_fetch(&action, parts, SS("action"), 0 TSRMLS_CC)) {
			...
			_25$$54 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultAction"), PH_NOISY_CC);
			zephir_update_property_this(this_ptr, SL("_action"), _25$$54 TSRMLS_CC);
		}
		ZEPHIR_OBS_VAR(paramsStr);
		if (zephir_array_isset_string_fetch(&paramsStr, parts, SS("params"), 0 TSRMLS_CC)) {
			ZEPHIR_SINIT_VAR(_26$$55);
			ZVAL_LONG(&_26$$55, 1);
		...
		if (zephir_fast_count_int(params TSRMLS_CC)) {
			ZEPHIR_INIT_VAR(_27$$57);
			zephir_fast_array_merge(_27$$57, &(params), &(parts) TSRMLS_CC);
			zephir_update_property_this(this_ptr, SL("_params"), _27$$57 TSRMLS_CC);
		} else {
			zephir_update_property_this(this_ptr, SL("_params"), parts TSRMLS_CC);
		}
	} else {
		_28$$59 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultNamespace"), PH_NOISY_CC);
		zephir_update_property_this(this_ptr, SL("_namespace"), _28$$59 TSRMLS_CC);
		_29$$59 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultModule"), PH_NOISY_CC);
		zephir_update_property_this(this_ptr, SL("_module"), _29$$59 TSRMLS_CC);
		_30$$59 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultController"), PH_NOISY_CC);
		zephir_update_property_this(this_ptr, SL("_controller"), _30$$59 TSRMLS_CC);
		_31$$59 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultAction"), PH_NOISY_CC);
		zephir_update_property_this(this_ptr, SL("_action"), _31$$59 TSRMLS_CC);
		_32$$59 = zephir_fetch_nproperty_this(this_ptr, SL("_defaultParams"), PH_NOISY_CC);
		zephir_update_property_this(this_ptr, SL("_params"), _32$$59 TSRMLS_CC);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Smce_Mvc_Router, add) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *pattern_param = NULL, *paths = NULL, *httpMethods = NULL, *route = NULL;
	zval *pattern = NULL;
	...
	ZEPHIR_CALL_METHOD(NULL, route, "__construct", NULL, 106, pattern, paths, httpMethods);
	zephir_check_call_status();
...
PHP_METHOD(Smce_Mvc_Router, mount) {
	...
	HashTable *_1$$5, *_4$$7;
	HashPosition _0$$5, _3$$7;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *group, *groupRoutes = NULL, *beforeMatch = NULL, *hostname = NULL, *routes = NULL, *route = NULL, **_2$$5, **_5$$7, *_6$$9;
	...
	if (Z_TYPE_P(group) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(smce_mvc_router_exception_ce, "The group of routes is not valid", "smce/mvc/router.zep", 670);
		return;
	}
	ZEPHIR_CALL_METHOD(&groupRoutes, group, "getroutes", NULL, 0);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(groupRoutes TSRMLS_CC))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(smce_mvc_router_exception_ce, "The group of routes does not contain any routes", "smce/mvc/router.zep", 675);
		return;
	}
	ZEPHIR_CALL_METHOD(&beforeMatch, group, "getbeforematch", NULL, 0);
	zephir_check_call_status();
	if (Z_TYPE_P(beforeMatch) != IS_NULL) {
		zephir_is_iterable(groupRoutes, &_1$$5, &_0$$5, 0, 0, "smce/mvc/router.zep", 687);
		for (
		  ; zephir_hash_get_current_data_ex(_1$$5, (void**) &_2$$5, &_0$$5) == SUCCESS
		  ; zephir_hash_move_forward_ex(_1$$5, &_0$$5)
		) {
			ZEPHIR_GET_HVALUE(route, _2$$5);
	...
	zephir_check_call_status();
	if (Z_TYPE_P(hostname) != IS_NULL) {
		zephir_is_iterable(groupRoutes, &_4$$7, &_3$$7, 0, 0, "smce/mvc/router.zep", 696);
		for (
		  ; zephir_hash_get_current_data_ex(_4$$7, (void**) &_5$$7, &_3$$7) == SUCCESS
		  ; zephir_hash_move_forward_ex(_4$$7, &_3$$7)
		) {
			ZEPHIR_GET_HVALUE(route, _5$$7);
	...
	if (Z_TYPE_P(routes) == IS_ARRAY) {
		...
		zephir_fast_array_merge(_6$$9, &(routes), &(groupRoutes) TSRMLS_CC);
		zephir_update_property_this(this_ptr, SL("_routes"), _6$$9 TSRMLS_CC);
	} else {
...
PHP_METHOD(Smce_Mvc_Router, notFound) {
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(smce_mvc_router_exception_ce, "The not-found paths must be an array or string", "smce/mvc/router.zep", 717);
		return;
	}
...
PHP_METHOD(Smce_Mvc_Router, setController) {
	...
	zephir_update_property_this(this_ptr, SL("_controller"), str TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Smce_Mvc_Router, setAction) {
	...
	zephir_update_property_this(this_ptr, SL("_action"), str TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Smce_Mvc_Router, getRouteById) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "smce/mvc/router.zep", 828);
	for (
...
PHP_METHOD(Smce_Mvc_Router, getRouteByName) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_routes"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "smce/mvc/router.zep", 843);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
