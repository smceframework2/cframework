...
PHP_METHOD(Smce_Components_Collection, each) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_map", NULL, 6, callback, _0);
...
PHP_METHOD(Smce_Components_Collection, map) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "array_map", NULL, 6, callback, _0, _1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, filter) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_filter", NULL, 8, _0, callback);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, pop) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	Z_SET_ISREF_P(_0);
	ZEPHIR_RETURN_CALL_FUNCTION("array_pop", NULL, 9, _0);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, diff) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_diff", NULL, 10, _0, items);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, flip) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_flip", NULL, 11, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, keys) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, last) {
	...
	if (zephir_fast_count_int(_1 TSRMLS_CC) > 0) {
		_2 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
		Z_SET_ISREF_P(_2);
		ZEPHIR_CALL_FUNCTION(&_0, "end", NULL, 12, _2);
		Z_UNSET_ISREF_P(_2);
		zephir_check_call_status();
	} else {
		ZVAL_NULL(_0);
...
PHP_METHOD(Smce_Components_Collection, prepend) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	Z_SET_ISREF_P(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 13, _0, value);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Smce_Components_Collection, reduce) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_RETURN_CALL_FUNCTION("array_reduce", NULL, 14, _0, callback, initial);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, reverse) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_reverse", NULL, 15, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, search) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_RETURN_CALL_FUNCTION("array_search", NULL, 16, value, _0, (strict ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, shift) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	Z_SET_ISREF_P(_0);
	ZEPHIR_RETURN_CALL_FUNCTION("array_shift", NULL, 17, _0);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, sort) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	Z_SET_ISREF_P(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "uasort", NULL, 18, _0, callback);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Smce_Components_Collection, splice) {
	...
	ZVAL_LONG(_2, length);
	Z_SET_ISREF_P(_0);
	ZEPHIR_CALL_FUNCTION(&_3, "array_splice", NULL, 19, _0, _1, _2, replacement);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _3);
	zephir_check_call_status();
...
PHP_METHOD(Smce_Components_Collection, transform) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_map", NULL, 6, callback, _0);
	zephir_check_call_status();
...
PHP_METHOD(Smce_Components_Collection, values) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_values", NULL, 20, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, unique) {
	...
	object_init_ex(return_value, smce_components_collection_ce);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "array_unique", NULL, 21, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Smce_Components_Collection, shuffle) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	Z_SET_ISREF_P(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "shuffle", NULL, 22, _0);
	Z_UNSET_ISREF_P(_0);
	zephir_check_call_status();
	RETURN_THIS();
