...
ZEPHIR_INIT_FUNCS(smce_core_eventmanager_method_entry) {
	...
	PHP_ME(Smce_Core_EventManager, push, arginfo_smce_core_eventmanager_push, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Smce_Core_EventManager, pull, arginfo_smce_core_eventmanager_pull, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Smce_Core_EventManager, bind, arginfo_smce_core_eventmanager_bind, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
