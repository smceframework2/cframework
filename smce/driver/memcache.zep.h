...
ZEND_BEGIN_ARG_INFO_EX(arginfo_smce_driver_memcache_getconfig, 0, 0, 1)
	ZEND_ARG_INFO(0, config)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(smce_driver_memcache_method_entry) {
	...
	PHP_ME(Smce_Driver_Memcache, getConfig, arginfo_smce_driver_memcache_getconfig, ZEND_ACC_PUBLIC)
