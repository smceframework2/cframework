...
ZEPHIR_INIT_FUNCS(smce_core_smceframework_method_entry) {
	...
	PHP_ME(Smce_Core_SmceFramework, router, NULL, ZEND_ACC_PROTECTED)
	PHP_ME(Smce_Core_SmceFramework, command, NULL, ZEND_ACC_PROTECTED)
	PHP_ME(Smce_Core_SmceFramework, isController, NULL, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Smce_Core_SmceFramework, isSessionStart, NULL, ZEND_ACC_PUBLIC)
  PHP_FE_END
};
